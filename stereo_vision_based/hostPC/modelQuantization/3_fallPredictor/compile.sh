...
compile() {
  vai_c_xir \
  --xmodel      ${BUILD}/quant_model_1Frame_4096/FallModel_int.xmodel \
  --arch        $ARCH \
  --net_name    FD_1Frame_4096_${TARGET} \
  --output_dir  ${BUILD}/compiled_model_1Frame_4096
}

compile 2>&1 | tee ${LOG}/compile_1Frame_4096_$TARGET.log
