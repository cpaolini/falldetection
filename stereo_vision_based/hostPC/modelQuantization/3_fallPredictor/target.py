...
def main():
    ...
    ap.add_argument('-t', '--target',     type=str,  default='kv260', choices=['kv260','zcu102','zcu104','u50','vck190'], help='Target board type (kv260,zcu102,zcu104,u50,vck190). Default is zcu102')
