...
# model = "/home/root/models/YOLOX_4096_QAT_kv260.xmodel"
model = "/home/root/models/B4096/YOLOX_4096_QAT_kv260.xmodel"
...
def runYolox(image, model, count, saveVideo):
    ...
    if BBox != None:
        ...
        # cv2.imwrite("/home/root/sourceFiles/output_4096_QAT_"+str(count)+".jpeg", result_image)
        if saveVideo:
            result_image = visual(image, outputs[0], cls_conf = confidence_threshold)
